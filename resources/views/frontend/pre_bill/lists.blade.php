      ...
      <div class="menu_inner">
        ...
        <div class="menu_detail">
          <div class="client_search">
            <input type="search" data-quote-type="pre-bill"  data-type="{{request()->segment(count(request()->segments()))}}" placeholder="Recherche Client/Concerne" class="quote_srch_field">
          ...
          <div class="profile_list " id="client_list_section">
            @include('frontend.pre_bill.pre_bill_listing')
          </div>
        </div>
      </div>
    </div>
