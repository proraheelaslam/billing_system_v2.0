            ...
            <div class="menu_box_table">
              ...
              <div class="profile_box_tableCell width33">
                <div class="addNewQuote_head_text text_center ">
                  ...
                  <p><b>{{$type == 'bill' ? 'Facture' : 'Devis'}}</b>No. <span class="qt_random_quote_number">{{$singleAddressArr['document_no']}}</span></p>
                </div>
              </div>
              <div class="profile_box_tableCell width33">
          ...
          <div class="profile_list">
            <ul>
                ...
                <div class="profile_box">
                  <div class="menu_box_table">
                    ...
                    <div class="profile_box_tableCell">
                      <div class="profile_edit_feildOut">
                        <div class="profile_edit_feild">
                          <input type="text" class="qt_concern_text" value="{{(count($client->quotes) > 0 ? $client->quotes[0]->concern : '')}}">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              @if(count($client->quotes))
                ...
                @php   $calaculationQuotes = (json_decode($client->quotes[0]->calculation_quote));
                @endphp
               @foreach($calaculationQuotes as $cal_qoute)
                  <li>
                          ...
                          <div class="profile_box">
                            <div class="menu_box_table">
                              ...
                              <div class="profile_box_tableCell">
                                <div class="profile_edit_feildOut">
                                  <div class="profile_edit_feild">
                                    <input min="1" type="number" value="{{$cal_qoute->quantity}}"  class=" calculate_ quote_quantity">
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="profile_box">
                            <div class="menu_box_table">
                              ...
                              <div class="profile_box_tableCell">
                                <div class="profile_edit_feildOut">
                                  <div class="profile_edit_feild">
                                    <input min="1" type="number" name="quote_price" class="quote_price" value="{{$cal_qoute->unit_price}}">
                                  </div>
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="menu_box_table addquote_btns_main">
                            <div class="profile_box_tableCell">
                                <div class="addquote_sendBtn">
                                    <input type="submit" data-status="update" data-type="{{$quote_type}}" value="Save" class="qt_common_sv_btn quote_cal_save_btn">
                                </div>
                            </div>
                            <div class="profile_box_tableCell">
                                <div class="addquote_sendBtn">
