    ...
    <div class="menu_auto">
      <div class="menu_inner">
        ...
        <div class="nextPrev_btns">
          <a style="display: block !Important" class="next_btn" href="{{route('menu.quote')}}"></a>
        </div>
        ...
        <div class="menu_detail">
          <div class="client_search">
            <input type="search" data-type="{{ request()->segment(count(request()->segments()))}}" placeholder="Recherche Client/Concerne" class="quote_srch_field">
